           ...
           <div className={cn
            ...
            headingFont.className
                ...
                <div className="mb-4 flex items-center border shadow-sm p-4 bg-amber-100 text-amber-700 rounded-full uppercase" >
                    ...
                    No 1 Collaboration Tool
                </div>
                <h1 className="text-3xl md:text-6xl text-center text-neutral-800 mb-6">
                    Collab Sphere helps team move
                </h1>
            ...
            <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl text-center mx-auto ",textFont.className)}>
                ...
                From high rises to the home office , the way 
                your team works is unique - accomplish it all with Collabsphere
            </div>
